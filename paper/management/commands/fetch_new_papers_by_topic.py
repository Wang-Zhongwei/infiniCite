...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--including_nested_fields', action='store_true', default=True, help='Whether to save references')
    ...
    def handle(self, *args, **kwargs):
        ...
        for paper_data in papers:
            ...
            if created:
                paper = self.paperService.assign_data_to_paper(paper, paper_data, including_nested_fields)
        ...
        Paper.objects.bulk_update(papers_to_save)

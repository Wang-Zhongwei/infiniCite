...
from .views import LibraryViewSet, LibraryPaperViewSet, AllPapersView, LibraryPaperView
from . import views
...
urlpatterns = [
    ...
    path('api/paper/<str:paper_pk>/libraries/', LibraryPaperViewSet.as_view({'post': 'add_to_libraries', 'delete': 'remove_from_libraries'}), name='paper-batch-operations'),
]

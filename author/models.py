...
class Author(models.Model):
    ...
    affiliations = ArrayField(models.CharField(max_length=255), blank=True, default=list, null=True)
...
class PublicationVenue(models.Model):
    ...
    alternate_names = ArrayField(models.CharField(max_length=255), blank=True, default=list, null=True)